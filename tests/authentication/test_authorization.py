...
class TestAuthorization:
    def test_successful_authorization(self, registration_page: RegistrationPage, dashboard_page: DashboardPage, login_page: LoginPage):
        ...
        registration_page.registration_form.fill(email='reg@gmail.com', username='username', password='password')
        ...
        login_page.login_form.fill(email='reg@gmail.com', password='password')
